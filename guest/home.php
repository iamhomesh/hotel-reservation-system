                ...
                <div class="card-body">
                    <div class="row text-center">
                        <dl class="col-4">
                            ...
                            <dt>Pending</dt>
                            <dd><span class="badge badge-warning"><?= $bookingRequest->countPending($guest_id) ?></span></dd>
                        </dl>
                        <dl class="col-4">
                            <i class="fas fa-smile" style="font-size: 30px"></i>
                            <dt>Confirmed</dt>
                            <dd><span class="badge badge-success"><?= $bookingRequest->countConfirmed($guest_id) ?></span></dd>
                        </dl>
                        <dl class="col-4">
                            <i class="fas fa-frown" style="font-size: 30px"></i>
                            <dt>Cancelled</dt>
                            <dd><span class="badge badge-danger"><?= $bookingRequest->countCancelled($guest_id) ?></span></dd>
                        </dl>
                    </div>
                </div>
            </div>
