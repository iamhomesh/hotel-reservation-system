...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        $userObj = new User();
        $loggedUserId = $userObj->login($username, $password);
        if ($loggedUserId) {
            $_SESSION['user'] = $loggedUserId;
            header('location: dashboard.php');
    ...
    <div class="container">
        <div class="min-vh-100 m-0 d-flex flex-column justify-content-center">
            <div class="card mx-auto">
                <div class="card-header text-center"><strong>ADMIN</strong></div>
                <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div id="lgn-div-username" class="input-group">
                                    ...
                                    <input type="text" name="username" value="<?= $username ?? "" ?>" class="form-control" placeholder="username" autocomplete="off" />
                                </div>
                            </div>
                        </div>
